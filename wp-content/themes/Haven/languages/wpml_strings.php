...
"Testimonials slider",
"Add one or more testimonials to slider.",
"Add a styled status",
"Status icon",
"Select icon that will be assigned to this status. For icons overview, Google \"typicons\".",
"This should be a status title.",
"Happy Clients",
"Number",
"This should be a status number.",
"Staff member",
"Select staff to insert",
"Page",
"of",
"Continue Reading..",
"E-Mail",
...
"Tumblr",
"RSS",
"<span class=\"dollar\">\$</span>49<span class=\"terms\">pm.</span>",
"Featured?",
"Should this pricing table be featured?",
"Search",
"Alternate",
"Default post/page",
"Primary Color",
...
"Subtitle displayed above toggled contact form.",
"Widget Areas",
...
"Should contact form be displayed in the footer?",
"Don't use gallery",
"Page header",
"Page icon",
"Select icon that will be assigned to this page. For icons overview, Google \"Typicons\".",
"Settings.",
"Slider Gallery",
...
"Service icon",
"Select icon that will be assigned to this service. For icons overview, Google \"Typicons\".",
"Icon position",
"Choose between icon placed at the top or at the bottom",
"Button text",
"Text of the button",
"Button link",
"Link button will point to",
"No icon",
"Category: %s",
"Tag: %s",
"Project Overview",
